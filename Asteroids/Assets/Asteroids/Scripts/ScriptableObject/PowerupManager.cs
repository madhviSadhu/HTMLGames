...
using System.Collections.Generic;
    ...
    public class PowerupManager : ScriptableObject
    {
        ...
        public PowerupBehaviour[] powerupPrefabs;
        private List<PowerupBehaviour> powerupList;
        ...
        {
            powerupList = new List<PowerupBehaviour>(powerupPrefabs.Length);
            foreach (var prefab in powerupPrefabs)
            {
                PowerupBehaviour powerup = Instantiate(prefab);
